...
Invalid parameter types trigger a `400 BAD_REQUEST` response with a descriptive message (see [Error Handling](#error-handling)). Requests exceeding the 1 000 000 record window also return `400 BAD_REQUEST`.
